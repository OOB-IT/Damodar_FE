...
import mainHoney from "../assets/product/mainHoney.jpg";
import ghee from "../assets/product/ghee (1).jpg";
import millets from "../assets/product/millets.jpg";
import snacks from "../assets/product/dry snacks.jpg";
import paper from "../assets/product/cup.jpg";
import sbt from "../assets/product/sugarcane bagasse compartment meal tray.jpg";
import furniture from "../assets/product/wooden bed.jpg";
import fertilizer from "../assets/product/vermicompost smooth and natural.jpg";
import { getProductCategories, getProducts } from "../services/api";
...
const Products = () => {
  ...
  useEffect(() => {
    getProductCategories().then((response) => {
      ...
      if (selectedProduct) {
        getProducts({ productTypeId: selectedProduct.productTypeId })
          .then((response) => {
